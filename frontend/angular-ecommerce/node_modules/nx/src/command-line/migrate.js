    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        for (const m of migrations) {
            try {
                ...
                logger_1.logger.error(`NX Failed to run ${m.name} from ${m.package}. This workspace is NOT up to date!`);
                throw e;
            }
        }
...
function runMigrations(root, opts, isVerbose, shouldCreateCommits = false, commitPrefix) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (migrationsWithNoChanges.length < migrations.length) {
            logger_1.logger.info(`NX Successfully finished running migrations from '${opts.runMigrations}'. This workspace is up to date!`);
        }
        else {
            logger_1.logger.info(`NX No changes were made from running '${opts.runMigrations}'. This workspace is up to date!`);
        }
    });
}
