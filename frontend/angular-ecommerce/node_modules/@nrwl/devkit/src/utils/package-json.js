...
function filterExistingDependencies(dependencies, existingDependencies) {
...
function addDependenciesToPackageJson(tree, dependencies, devDependencies, packageJsonPath = 'package.json') {
    ...
    const filteredDependencies = filterExistingDependencies(dependencies, currentPackageJson.devDependencies);
    const filteredDevDependencies = filterExistingDependencies(devDependencies, currentPackageJson.dependencies);
    if (requiresAddingOfPackages(currentPackageJson, filteredDependencies, filteredDevDependencies)) {
        (0, json_1.updateJson)(tree, packageJsonPath, (json) => {
            json.dependencies = Object.assign(Object.assign(Object.assign({}, (json.dependencies || {})), filteredDependencies), (json.dependencies || {}));
            json.devDependencies = Object.assign(Object.assign(Object.assign({}, (json.devDependencies || {})), filteredDevDependencies), (json.devDependencies || {}));
